...
const isValidArray = function (tags){
    return Array.isArray(tags)
}


module.exports = { isValid, isValidTitle, isValidName, isValidMobile, isValidEmail, isValidPassword, isValidDate, isValidTitleName,isValidArray }